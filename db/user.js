...
const getUserByUsername = async (username) => await prisma.user.findUnique({ where: { username }});
const createUser = async (username, password) => await prisma.user.create({ data: { username, password } });
